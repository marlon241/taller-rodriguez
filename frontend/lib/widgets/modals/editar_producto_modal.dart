...
void mostrarModalEditarProducto(BuildContext context) {
                  ...
                  children: [
                    ...
                    Row(
                      children: [
                        ...
                        const SizedBox(width: 16),
                        Expanded(child: _modalTextField('Stock máximo:', stockMaximoController, keyboardType: TextInputType.number)),
                      ],
                    ),
                    const SizedBox(height: 16),
                    _modalTextField('Descripción (Opcional):', descripcionController, maxLines: 4),
                    const SizedBox(height: 28),
                    _botonGuardar('Guardar cambios', () => Navigator.pop(context)),
                  ],
                ),
              ),
            ),
