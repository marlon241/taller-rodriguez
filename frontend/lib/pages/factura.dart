        ...
        Container(
          ...
          child: Column(
            children: [
              ...
              FacturaItemRow(cantidad: 1, nombre: "Cambio de aceite", tipo: "Servicio", precio: 10.00),
              FacturaItemRow(cantidad: 2, nombre: "Aceite de caja", tipo: "Producto", precio: 15.43),
              ...
              Container(
                ...
                child: const Row(
                  children: [
                    ...
                    Expanded(flex: 1, child: Text("TIPO", style: TextStyle(fontWeight: FontWeight.bold, fontSize: 12))),
                    Expanded(flex: 1, child: Text("STOCK", textAlign: TextAlign.right, style: TextStyle(fontWeight: FontWeight.bold, fontSize: 12))),
                  ],
                ),
              ),
              _buildProductRow("Cambio de aceite", 10.00, "Servicio", null),
              _buildProductRow("Aceite de caja", 15.43, "Producto", 16),
              _buildProductRow("Refrigerante", 25.00, "Servicio", 33),
              _buildProductRow("Cambio de neumáticos", 15.00, "Producto", null),
            ],
          ),
        ),
      ],
...
Widget _buildProductRow(String nombre, double precio, String tipo, int? stock) {
  ...
  return Container(
    ...
    child: Row(
      children: [
        ...
        Expanded(flex: 1, child: Text(tipo, style: TextStyle(fontSize: 13, color: isServicio ? Colors.orange.shade700 : Colors.blue.shade700, fontWeight: FontWeight.w600), overflow: TextOverflow.ellipsis)),
